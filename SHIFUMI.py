...
# JOUEUR CONTRE ORDI
    ...
    while i < int(NbrManches):
        ...
        if int(choix_joueur) == 1 and choix_ordi == 3:
            ...
            print('En effet la pierre gagne contre le ciseau ordi vous avez gagné ')
            score_ordi += 1
            print('Le score de l\'ordi est de ' + str(score_ordi) + '\n' + Joueur + ' votre score est de ' + str(score_joueur))
    ...
    print ("\nVous avez décidé de jouer contre Frankulin!")
    Joueur = input("\nQuel est le nom du joueur ?\n")
    print ("ok c'est un match entre " + Joueur + " et Frankulin " )
    ...
    while i < int(NbrManches):
        print(Joueur + " 1: pierre 2: papier 3: ciseau ")
        choix_joueur = input()
        choix_Frankulin = random.randint(1,3)

        if int(choix_joueur) == 1 and choix_Frankulin == 2:
            print('En effet le papier gagne contre la pierre ' + Joueur + ' a gagné !')
            score_joueur += 1
            print('Le score de l\'ordi est de ' + str(score_Frankulin) + '\n' + Joueur + ' votre score est de ' + str(score_joueur))
        elif int(choix_joueur) == 2 and choix_Frankulin == 1:
            print('En effet le papier gagne contre la pierre ' + Joueur + ' vous avez gagné !')
            score_joueur += 1
            print('Le score de ' + Joueur + ' est de ' + str(score_joueur) + '\n Ordi votre score est de ' + str(score_Frankulin))
       
        if int(choix_joueur) == 1 and choix_Frankulin == 3:
            print('En effet la pierre gagne contre le ciseau ' + Joueur + ' vous avez gagné ')
            score_joueur += 1
            print('Le score de ' + Joueur + ' est de ' + str(score_joueur) + '\n Ordi votre score est de ' + str(score_Frankulin))
        elif int(choix_joueur) == 3 and choix_Frankulin == 1:
            print('En effet la pierre gagne contre le ciseau l\'ordi vous avez gagné ')
            score_joueur += 1
            print('Le score de l\'ordi est de ' + str(score_Frankulin) + '\n' + Joueur + ' votre score est de ' + str(score_joueur))
        
        if int(choix_joueur) == 2 and choix_Frankulin == 3:
            print('En effet le ciseau gagne contre le papier l\'ordi vous avez gagné ')
            score_joueur += 1
            print('Le score de l\'ordi est de ' + str(score_Frankulin) + '\n' + Joueur + ' votre score est de ' + str(score_joueur))
        elif int(choix_joueur) == 3 and choix_Frankulin == 2:
            print('En effet le ciseau gagne contre le papier ' + Joueur + ' vous avez gagné ')
            score_joueur += 1
            print('Le score de ' + Joueur + ' est de ' + str(score_joueur) + '\n Ordi votre score est de ' + str(score_Frankulin))
    ...
    if score_joueur >= score_Frankulin:
        print(Joueur + " a gagné la partie")
    else :
        print("Frankulin a gagné la partie") 


# SI PERSONNE NE VEUT JOUER LE PROGRAMME SE FINIT
else : 
    print('Bye Bye !')
